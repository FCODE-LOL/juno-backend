...
public class ProductService {
    ...
    public Response<ProductDto> addProduct(ProductDto productDto) {
        ...
        return new Response<>(200, SUCCESS_MESSAGE, modelMapper.map(productRepository.save(product), ProductDto.class));
    }
    ...
    public Response<ProductDto> updateProduct(ProductDto productDto) {
        ...
        return new Response<>(200, SUCCESS_MESSAGE, productResponse);
    ...
    public Response<List<ProductByGroupDto>> getProductByType(int typeId, Comparator<ProductByGroupDto> comparator) {
        ...
        if (!currentType.getParentId().equals(currentType.getId()))
            types.add(currentType);
        for (Type type : types) {
            List<Product> productList = type.getProducts();
            productList.removeIf(Product::getIsDisable);
        ...
        return new Response<>(200, SUCCESS_MESSAGE, setColorIdsListProductByGroupDto(productByGroupDtoList));
    }
    ...
    public Response<ProductDto> getProductById(String id) {
        ...
        return new Response<>(200, SUCCESS_MESSAGE, productDto);
    }
    ...
    public Response<List<TypeDto>> getType() {
        ...
        return new Response<>(200, SUCCESS_MESSAGE, typeDtoList);
    }

    @Transactional
    public Response<String> addTypeList(List<TypeDto> addList) {
    ...
    @Transactional
    public Response<String> updateTypeList(List<TypeDto> updateList) {
    ...
    @Transactional
    public Response<String> deleteType(int typeId) {
    ...
    public ProductByGroupDto setColorIdsProductByGroupDto(ProductByGroupDto productByGroupDto) {
        ...
        for (String color : colorIdList) {
            colorIds.append(color);
        }
        productByGroupDto.setColorIds(colorIds.toString());
